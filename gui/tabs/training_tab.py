...
class TrainingTab(QScrollArea):
    ...
    def _create_ui(self):
        ...
        settings_layout.addWidget(self.gambling_train, 7, 0, 1, 2)
        ...
        settings_layout.addWidget(self.gambling_settings_widget, 8, 0, 1, 2)
        ...
        settings_layout.addWidget(self.unity_widget, 9, 0, 1, 2)
