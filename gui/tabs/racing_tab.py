...
class RacingTab(QScrollArea):
    ...
    def _create_ui(self):
        ...
        max_clock_layout.addWidget(QLabel("Maximum clocks per race:"))
        self.max_clock_per_race = QSpinBox()
        self.max_clock_per_race.setRange(1, 99)
        self.max_clock_per_race.valueChanged.connect(self._save_racing)
        max_clock_layout.addWidget(self.max_clock_per_race)
        max_clock_layout.addStretch()
