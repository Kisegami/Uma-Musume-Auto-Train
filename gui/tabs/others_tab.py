...
class OthersTab(QScrollArea):
    ...
    def _create_ui(self):
        ...
        dump_desc = QLabel(
            "Writes found lobby template match regions into a JSON file during the run.\n"
    ...
    def _test_webhook(self):
        ...
        try:
            ...
            if success:
                QMessageBox.information(self, "Test Webhook", f"Success: {message}")
            else:
                QMessageBox.warning(self, "Test Webhook", f"Failed: {message}")
        except ImportError:
