...
def find_text_on_screen(search_text, region=None, confidence_threshold=70):
    ...
    try:
        ...
        from core.Unity.ocr import extract_text_with_data
        data = extract_text_with_data(Image.fromarray(cleaned), config="-c preserve_interword_spaces=1")
...
def handle_event_choice():
    ...
    from utils.constants.unity import EVENT_REGION
