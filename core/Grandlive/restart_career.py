...
from core.Grandlive.skill_auto_purchase import click_image_button
...
def execute_skill_purchase_workflow(available_points: int):
    ...
    from core.Grandlive.skill_auto_purchase import execute_skill_purchases
    from core.Grandlive.skill_recognizer import deduplicate_skills
    try:
...
def start_career() -> bool:
    ...
    try:
        ...
        if tazuna_hint_matches:
            from core.Grandlive.execute import arm_skip_infirmary_check_for_new_turn
