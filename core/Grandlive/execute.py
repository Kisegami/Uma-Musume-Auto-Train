...
from core.Grandlive.state import (
...
from core.Grandlive.event_handling import count_event_choices, load_event_priorities, analyze_event_options, handle_event_choice, click_event_choice

# Import training handling functions
from core.Grandlive.training_handling import go_to_training, check_training, do_train, check_support_card, check_failure, check_hint, choose_best_training, calculate_training_score, check_training_api

# Import race handling functions
from core.Grandlive.races_handling import (
    ...
    while True:
        ...
        try:
            ...
            if complete_career_matches:
                ...
                from core.Grandlive.restart_career import career_lobby_check
            ...
            if maiden_lobby_matches:
                ...
                if tap_on_image("assets/grandlive/race_btn_gl.png", min_search=10):
                    ...
                    if two_star_matches:
                        ...
                        from core.Grandlive.races_handling import execute_race_after_selection
        ...
        if best_training:
            ...
            if do_race_when_bad_training:
                ...
                from core.Grandlive.logic import all_training_unsafe
                ...
                if all_training_unsafe(results_training, max_failure):
                    ...
                    if not is_racing_available(year):
                        ...
                        from core.Grandlive.races_handling import check_race_in_database
