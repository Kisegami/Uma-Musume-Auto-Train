...
from core.Grandlive.state import check_skill_points_cap, check_current_year
from core.Grandlive.ocr import extract_text
import os

# Helper function to get project root directory
def _get_project_root():
    """Get the project root directory (3 levels up from core/Grandlive/)"""
...
def enter_race_selection_screen():
    ...
    if not races_clicked:
        ...
        save_debug_screenshot("ura_races_button_not_found")
        return False
...
def find_and_do_race(year_override=None):
    ...
    try:
        ...
        if skip_goal_check:
            ...
            from core.Grandlive.state import check_goal_name
