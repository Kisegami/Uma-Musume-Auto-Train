...
def check_failure(screenshot, train_type):
    ...
    from utils.constants.trackblazer import FAILURE_REGION_SPD, FAILURE_REGION_STA, FAILURE_REGION_PWR, FAILURE_REGION_GUTS, FAILURE_REGION_WIT
    ...
    for attempt in range(3):
        ...
        from core.Trackblazer.ocr import extract_text_with_data, extract_text
...
def choose_best_training(training_results, config, current_stats, year=None, item_state=None):
    ...
    from core.Trackblazer.logic import filter_by_stat_caps, are_all_stats_capped
...
def calculate_training_score(support_detail, hint_found, training_type):
    ...
    """
    # Load scoring rules from training_score_trackblazer.json
    scoring_rules = {}
    try:
