...
from core.Trackblazer.skill_auto_purchase import (
    click_image_button,
...
def check_skill_points(screenshot=None):
    ...
    if result > 0:
        from core.Trackblazer.skill_auto_purchase import cache_skill_points
...
def check_current_stats(screenshot=None):
    ...
    """
    from utils.constants.trackblazer import SPD_REGION, STA_REGION, PWR_REGION, GUTS_REGION, WIT_REGION
