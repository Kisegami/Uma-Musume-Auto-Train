...
TRACKBLAZER_TEMPLATE_REGIONS = {
    ...
    "assets/buttons/infirmary_btn2.png": (13, 1592, 381, 213),
    ...
    "assets/buttons/race_day_btn.png": (372, 1506, 195, 137),
    "assets/buttons/race_ura.png": (595, 1497, 221, 188),
    "assets/buttons/races_btn.png": (789, 1671, 246, 137),
    "assets/buttons/recreation_btn.png": (272, 1663, 292, 142),
    ...
    "assets/buttons/skills_btn.png": (778, 1465, 249, 138),
